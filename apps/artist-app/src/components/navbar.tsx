...
export default function Navbar() {
  ...
  return (
    <div
      className="absolute top-0 z-50 flex h-[3.25rem] w-full flex-row items-center justify-between border-b-[0.5px] border-[#313131] bg-white/[0.05] p-2 px-4 backdrop-blur-[40px] sm:px-6 lg:px-10"
      style={{
