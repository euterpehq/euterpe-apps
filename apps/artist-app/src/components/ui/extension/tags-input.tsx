    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex flex-wrap items-center gap-1 overflow-hidden rounded-[6px] border-[0.8px] border-[#303033] bg-[#1E1E1E] p-1 ring-0 ring-muted",
            {
        ...
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative flex items-center gap-1 truncate rounded bg-primary/20 px-1 aria-disabled:cursor-not-allowed aria-disabled:opacity-50 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground",
              )}
              variant="outline"
            >
          ...
          <Input
            ...
            className={cn(
              "h-7 min-w-fit flex-1 border-none px-1 outline-0 placeholder:text-[#797979] focus-visible:border-0 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0",
