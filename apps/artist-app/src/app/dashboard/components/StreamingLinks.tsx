            ...
            <div className="mt-4 grid grid-cols-1 gap-x-4 gap-y-4">
                <div className="flex justfiy-start items-center gap-x-2 p-2.5 w-[100%] h-[40px] border rounded-sm">
                    <div className="w-[16px] h-[16px] border rounded-full">
                     ...
                     <input className="w-full bg-transparent focus:outline-none" placeholder="Spotify" type="text" name="" id="" />
                </div>
                 <div className="flex justfiy-start items-center gap-x-2 p-2.5 w-[100%] h-[40px] border rounded-sm">
                    <div className="w-[16px] h-[16px] rounded-full">
                        <Image src="/images/shazam.png" alt="shazam" width={200} height={200}/>
                  </div>
                    <input className="w-full bg-transparent focus:outline-none" placeholder="Shazam" type="text" name="" id="" />
                </div>
               <div className="flex justfiy-start items-center gap-x-2 p-2.5 w-[100%] h-[40px] border rounded-sm">
                  <div className="w-[16px] h-[16px] rounded-full">
                    <Image src="/images/youtube_music.png" alt="youtube_music" width={200} height={200}/>
                  </div>
                  <input className="w-full bg-transparent focus:outline-none" placeholder="Youtube Music" type="text" name="" id="" />
                </div>
                  <div className="flex justfiy-start items-center gap-x-2 p-2.5 w-[100%] h-[40px] border rounded-sm">
                     <div className="w-[16px] h-[16px] rounded-full">
                    <Image src="/images/grooveshark.png" alt="grooveshark" width={200} height={200}/>
                  </div>
                     <input className="w-full bg-transparent focus:outline-none" placeholder="Groovesshark" type="text" name="" id="" />
                </div>
              <div className="flex justfiy-start items-center gap-x-2 p-2.5 w-[100%] h-[40px] border rounded-sm">
                  <div className="w-[16px] h-[16px] rounded-full">
                    <Image src="/images/sound_cloud.png" alt="sound_cloud" width={200} height={200}/>
                  </div>
                  <input className="w-full bg-transparent focus:outline-none" placeholder="SoundCloud" type="text" name="" id="" />
                </div>
                  <div className="flex justfiy-start items-center gap-x-2 p-2.5 w-[100%] h-[40px] border rounded-sm">
                    <div className="w-[16px] h-[16px] rounded-full">
                     <Image src="/images/apple_music.png" alt="apple_music" width={200} height={200}/>
                  </div>
                    <input className="w-full bg-transparent focus:outline-none" placeholder="Apple Music" type="text" name="" id="" />
                </div>
              </div>
  </>
  )
