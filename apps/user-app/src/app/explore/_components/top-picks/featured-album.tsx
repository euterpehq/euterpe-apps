...
import SliderPage from '@/app/explore/_components/top-picks/top-pick-slider'
import { useQuery } from '@tanstack/react-query'
import { getAlbumsAndArtists } from '@/lib/queries/combined/get-top-picks'
