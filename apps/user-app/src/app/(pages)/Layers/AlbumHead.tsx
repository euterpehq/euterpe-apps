        ...
        <div className="w-full flex gap-10  border">
            ...
            <div className="flex flex-col gap-10">
                <div className="flex flex-col gap-3">
                    <div className="bg-[#c1ff701a] w-[30px] h-[22px]  flex items-center justify-center rounded-[4px] text-[#C1FF70]">
                        <p>EP</p>
                    </div>
                   <div> <h1 className="text-[32px] font-figtree tracking-[-0.64px]">Astrid S</h1></div>
                    <div className="flex items-center gap-3">
                        <div className="w-[16px] h-[16px]"><Image src={img} alt="" className="w-full h-full object-cover rounded-[120px]"/></div>
                        <h1 className="text-[14px] font-figtree tracking-[-0.28px]">Astrid S</h1>
                    </div>
                    <div className="flex items-center gap-3">
