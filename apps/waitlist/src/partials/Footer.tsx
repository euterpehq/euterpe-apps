...
export default function Footer() {
  return (
    <div
      className="flex h-full w-full flex-col justify-between bg-[#0C0C0C] sm:gap-[50px] md:gap-[120px]"
      style={{ padding: "64px 60px 40px 60px" }}
    >
      <div className="">
        <div className="flex items-start justify-between">
          <Logo />
          <div className="flex-col items-end gap-6 sm:hidden md:flex">
        ...
        <div className="flex flex-col gap-10 sm:mt-5 md:mt-0">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex w-full justify-between sm:flex-col sm:items-start sm:gap-5 md:flex-row md:items-center">
